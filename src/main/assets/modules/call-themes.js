...
function sheetcolor(){
    ...
    if (currentTheme === 'dark') {
        ...
        if (currentColorTheme === 'Material You (Berry pop blue 44)') {
            sendThemeToAndroid('sheet-blue-dark');
        } else if (currentColorTheme === 'Material You (Raisin purple 100)') {
            sendThemeToAndroid('sheet-purple-dark');
        } else if (currentColorTheme === 'Material You (Olive pop green 49)') {
            sendThemeToAndroid('sheet-yellow-dark');

        } else if (currentColorTheme === 'Material You (Forest green 33)') {
            sendThemeToAndroid('sheet-green-dark');

        } else if (currentColorTheme === 'Material You (Chestnut cool red 122)') {
          sendThemeToAndroid('sheet-red-dark');
        } else if (currentColorTheme === 'Material You (Raspberry pink P99)') {
            sendThemeToAndroid('sheet-pink-dark');
          } else if (currentColorTheme === 'Material You (Deep charcoal 83)'){
            sendThemeToAndroid('sheet-charcoal-dark');

          } else if (currentColorTheme === 'Material You (Hint orange 33)'){
            sendThemeToAndroid('sheet-orange-dark');
        ...
        if (currentColorTheme === 'Material You (Berry pop blue 44)') {
            sendThemeToAndroid('sheet-blue-light');
        } else if (currentColorTheme === 'Material You (Raisin purple 100)') {
            sendThemeToAndroid('sheet-purple-light');
        } else if (currentColorTheme === 'Material You (Olive pop green 49)') {
            sendThemeToAndroid('sheet-yellow-light');

        } else if (currentColorTheme === 'Material You (Forest green 33)') {
            sendThemeToAndroid('sheet-green-light');

        } else if (currentColorTheme === 'Material You (Chestnut cool red 122)') {
          sendThemeToAndroid('sheet-red-light');
        } else if (currentColorTheme === 'Material You (Raspberry pink P99)') {
            sendThemeToAndroid('sheet-pink-light');
          } else if (currentColorTheme === 'Material You (Deep charcoal 83)'){
            sendThemeToAndroid('sheet-charcoal-light');

          } else if (currentColorTheme === 'Material You (Hint orange 33)'){
            sendThemeToAndroid('sheet-orange-light');
